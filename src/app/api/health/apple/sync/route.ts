...
export async function POST(req: Request) {
  try {
    ...
    return NextResponse.json({ success: true, message: 'Apple Health data synced successfully' });
  } catch (error: any) {
    console.error('Error in /api/health/apple/sync:', error);
